...
const titles: Record<string, string> = {
  ...
  "/cis": "Frameworki (przekierowanie)",
  "/cis/assess": "Oceny (przekierowanie)",
  ...
  "/actions": "Dzialania",
  "/audit": "Audit Trail",
  "/frameworks": "Biblioteka Frameworkow",
  "/framework-mappings": "Mapowanie Frameworkow",
  "/assessments": "Oceny Frameworkow",
